...
public class EmailService extends Thread{
	...
	//não é recomendado utilizar utilizando o Stateless
	...
	public void run() {
		...
		//properties.put("mail.smtp.host", "smtp.gmail.com");// Servidor gmail.com Google
		props.put("mail.smtp.host", System.getProperty("email-project.mail.smtp.host"));// Servidor point25.com Google
		props.put("mail.smtp.port", System.getProperty("email-project.mail.smtp.port"));//Porta do servidor
