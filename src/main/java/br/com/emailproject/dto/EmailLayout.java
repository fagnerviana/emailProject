...
public class EmailLayout {
	...
	private String gerarRodape(StringBuilder texto) {
		return texto.append("E-mail automtaico. Favor não responder esse e-mail!").toString();
    ...
    public Email montarEmailSecretario(String destinatario, String assunto) {
		...
		texto
		.append("Solicito alteração de senha do sistema do Secretario")
		.append(QUEBRA_DE_LINHA_DUPLA);
		
		texto
		.append("Ususario é o numero do CPF");
